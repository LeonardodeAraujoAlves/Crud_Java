...
public class InsertArquivo implements Runnable {
    ...
    public void run() {
        /**
         * Thead que faz o monitoramento
         */
        Thread Monitor = new Thread(() -> {
            try {
                System.out.println("iniciada");
                BufferedReader leitor = new BufferedReader(new FileReader(ARQUIVO));
                FileWriter consumo = new FileWriter(ARQUIVO);
                String linha;
                while (true) {
                    // System.out.println("inserindo");
                    linha = leitor.readLine();
                    if (linha != null) {
                        System.out.println("nova linha encontrada");
                        ...
                        consumo.flush();
                        Thread.sleep(10000); // aguarda 20 segundo antes de verificar novamente o arquivo
                    }
                }
    ...
    /**
     *
     * Método utilizado para extrair os dados das linha do arquivo de texto e
     * armazenar em um array de string para que posteriormente esses valores
     * sejam inseridos no banco de dados atravéz de Statements, alem disso este
     * método diferencia os tipos de dados atravéz do tamanho do array e
     * direciona para a entidade correspondente no banco de dados
     *
